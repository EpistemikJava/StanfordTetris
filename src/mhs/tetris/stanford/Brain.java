...
interface Brain {
    /**
     * Move is used as a struct to store a single Move ("static" here means it does not have a pointer to an enclosing Brain
     * object, it's just in the Brain namespace.)
     */
    static class Move {
        int x;
        int y;
     ...
     * is possible. The board should be in the committed state when this is called. "limitHeight" is the bottom section of the
     * board that where pieces must come to rest -- typically 20.
     * 
     * @param board - in play
     * @param piece - to move
